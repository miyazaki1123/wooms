...
=  How to Translate Load More Button Label? =
You have to use [Loco Translate](https://wordpress.org/plugins/loco-translate/) Plugin to translate. Edit template file, add your desire translateable string, Then add New translate file, Find your String, Add your translation. 
